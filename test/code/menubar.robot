...
Select Language And Verify
    ...
    # ✅ ข้ามการเปลี่ยนภาษาอังกฤษ เพราะเป็นค่าเริ่มต้น
    IF  '${lang_code}' != 'en'  
...
Verify Page Contains Texts
    ...
    # ✅ เพิ่ม Log เพื่อดูปัญหากรณีหาไม่เจอ
...
English To Thai
    [Documentation]    Starting from English, switch to Thai and verify texts.
    Open Browser To Home Page
    Sleep    ${WAIT_TIME}
    Select Language And Verify    th    ${LANG_TO_THAI}

English To Chinese
    [Documentation]    Starting from English, switch to Chinese and verify texts.
    Open Browser To Home Page
    Sleep    ${WAIT_TIME}
    Select Language And Verify    zh    ${LANG_TO_CHINESE}

Thai To English
    [Documentation]    Starting from Thai, switch to English and verify texts.
    Open Browser To Home Page
    Sleep    ${WAIT_TIME}
    Select Language And Verify    en    ${LANG_TO_ENGLISH}

Chinese To Thai
    [Documentation]    Starting from Chinese, switch to Thai and verify texts.
    Open Browser To Home Page
    Sleep    ${WAIT_TIME}
    Select Language And Verify    th    ${LANG_TO_THAI}
