...
<div class="container">
    <div class="justify-content-center">
        ...
        <div class="card col-8" style="padding: 16px;">
            <div class="card-body">
                <h4 class="card-title">{{ translateText('แก้ไขข้อมูลผู้ใช้งาน') }}</h4>
                ...
                <div class="form-group row">
                    <p class="col-sm-3"><b>{{ translateText('Email') }}</b></p>
                    <div class="col-sm-8">
                        <input type="text" name="email" value="{{ $user->email }}" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                    <p class="col-sm-3"><b>{{ translateText('Password') }}</b></p>
                    <div class="col-sm-8">
                        <input type="password" name="password" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                    <p class="col-sm-3"><b>{{ translateText('Confirm Password') }}</b></p>
                    <div class="col-sm-8">
                        <input type="password" name="password_confirmation" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                    <p class="col-sm-3"><b>{{ translateText('Role') }}</b></p>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select id='status' class="form-control" style='width: 200px;' name="status">
                            <option value="1" {{ "1" == $user->status ? 'selected' : '' }}>{{ translateText('กำลังศึกษา') }}</option>
                            <option value="2" {{ "2" == $user->status ? 'selected' : '' }}>{{ translateText('จบการศึกษา') }}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-6">
                        <p for="category"><b>{{ translateText('Department') }} <span class="text-danger">*</span></b></p>
                    ...
                    <div class="col-md-6">
                        <p for="category"><b>{{ translateText('Program') }} <span class="text-danger">*</span></b></p>
                ...
                <a class="btn btn-light mt-5" href="{{ route('users.index') }}">{{ translateText('Cancel') }}</a>
                {!! Form::close() !!}
            </div>
        </div>
    </div>
